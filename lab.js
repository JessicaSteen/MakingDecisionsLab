...
/*
  ...
  and Brittani were born in the same year. If they were, console.log 'Amy & Brittani were born in the same year'.
...
/*
  ...
  If it is 60 degrees or below, one should wear a jacket and carry an umbrella. Come up
  with your own clothing suggestions based on those temperature parameters when it is 
  not raining.
*/
//CODE HERE
...
/*
  ...
  the score by one. If your code is successful, you will see your logged statement 
  7 times.
*/
...
////////// PROBLEM 10 //////////
// Try to change the value of changeMyMind (irrespective of whether it 
// is true or false) and then console.log it's new status. It should log 
// true. Hint: use the not operator.
